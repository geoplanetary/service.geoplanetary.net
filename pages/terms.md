...
- ## このサービスの利用
- ### このサービスを利用するための要件
  id:: 65ec77d9-dbee-4e54-8e70-d766a23e6b3d
	- このサービスを利用するには、次に示す要件をすべて満たしていなくてはなりません。
		...
		- この規約、もしくはポリシーの違反によるアクセス停止の措置を受けたことがないこと
		  ([問題がある場合に運営者が行う措置](65ec7a92-7da8-4455-af07-dd2787e09e66)のセクションをご確認ください)
...
- ### サービスへのアクセスとアカウント
	- 前述の要件をすべて満たし、この規約と関連するポリシーを遵守することに同意した利用者に対して、運営者はこのサービスの利用(サービスへのアクセス、投稿、コンテンツのアップロードなどを含みます)を許可します。
...
- ### 利用者のコンテンツの使用許可
  id:: 65ec791e-f746-40fd-b617-32c58690b527
...
- ### 利用者のコンテンツ
	- このサービスは、利用者にコンテンツをアップロードし、公開・または共有する機会を提供します。
	  利用者がこのサービスにコンテンツをアップロードした場合でも利用者のコンテンツにかかわる利用者の権利が変化することはありません。
		- 利用者のコンテンツがこのサービスでどのように使用されるかは、[利用者のコンテンツの使用許可](65ec791e-f746-40fd-b617-32c58690b527)のセクションをご覧ください。
