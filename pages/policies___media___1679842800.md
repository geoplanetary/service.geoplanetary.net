-
- [メディアポリシー](policies/media) / [過去の版](policies/media/revisions) / 2023-03-27
- [:div {:style "padding:6px;border:1px solid hsl(0deg,100%,70%);border-radius:12px;background-color:hsl(0deg 100% 70% / 20%);"} [:div [:b "現在、過去の版を表示しています。"]] [:div "このページは、2023-03-27に発効された過去の版です。現在適用されているコミュニティポリシーとの比較のために残されており、ここに表示されている文書が契約として効力を発することはありません。"]]
- # メディアポリシー
	- 発効日: 2023-03-27 00:00 +09:00 (JST)
- ***
- ## はじめに
- ### この文書について
...
- ### モデレーションに著しい支障をきたすコンテンツ
  以下のようなコンテンツは、運営者、およびモデレーターによるモデレーションに支障をきたすため、このサービスでアップロード、公開、共有を行わないでください。
	- 極めて暴力的、残酷な描写や残忍な表現を含んだり、それを想起させるようなコンテンツ
